...
class _PaySampleAppState extends State<PaySampleApp> {
 ...
 _checkDevice() async{
    return PaymentConfiguration.fromAsset('gpay.json').catchError((error) {
  debugPrint('Error loading Google Pay configuration: $error');
  });}
      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.payment, color: Colors.teal, size: 40),
          ),
          const Text(
            'Amanda\'s Polo Shirt',
            style: TextStyle(
          ...
          const SizedBox(height: 15),
          // Google Pay Button configured using an asset
          ...
          // Apple Pay Button configured using a string
          ApplePayButton(

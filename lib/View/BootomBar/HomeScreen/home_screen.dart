              ...
              children: [
                ...
                BlocBuilder<HomeBloc, HomeState>(builder: (context, state) {
                  if (state is HomeLoadSuccess) {
                    seruLogPrint(
                        "----->>>a>>>${state.packageAllModel.data![0].price}");
                    ...
                    return Container(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          var packageModelData = state.packageAllModel.data![index];
                          return InkWell(
                            onTap: () {
                              // print('fgcg');
                              // Navigator.push(
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LoginScreenBuilder(),
                                  ));
                            },
                            child: Container(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: CustomText(
                                          text:
                                          "\£ ${packageModelData.price.toString()}",
                                                          ...
                                                          children: [
                                                            ElevatedButton(
                                                                style: ElevatedButton.styleFrom(
                                                                    backgroundColor: is_cliced_for_own == false
                                                                        ? BootomBarColor
                                                                        : Colors
                                                                        .white),
                                                                onPressed:
                                                            ...
                                                            ElevatedButton(
                                                                style: ElevatedButton.styleFrom(
                                                                    backgroundColor: is_cliced_for_own == true
                                                                        ? BootomBarColor
                                                                        : Colors
                                                                        .white),
                                                                onPressed:

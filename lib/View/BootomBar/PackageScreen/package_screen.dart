         ...
         child:  Padding(
           ...
           child: SingleChildScrollView(
             child: GridView.builder(
               shrinkWrap: true,
               itemCount: state.packageAllModel.data!.length,
                     ...
                     children: [
                       Align(
                         ...
                         child:  Container(
                           ...
                           child: CustomText(text: packageModelData.price.toString(),text_color: main_text_white_color ,fontSize: 17, fontWeight: FontWeight.w500),
                         ),
                       ),
                       SizedBox(height: 5,),

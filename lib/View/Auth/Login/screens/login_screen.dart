                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ///  Login profileeeeeeeeeeeeeeeeeeee
                      CustomButton(onTap: () {
                        if(_emailController.text.isEmpty || _psswordController.text.isEmpty){
                          quickAlertWrong(context, "Warning", "Please fill up", 2);
                        }else{
                          Provider.of<LoginController>(context,listen: false).getLoginInfoProvider(_emailController.text, _psswordController.text, _deviceId!, context);
                        }
                      }, text: is_clicked_loginbutton==true? "Login Processing" : "Sign In", button_text_fontSize: 22, button_height: 45)
                      ,SizedBox(
                        height: 20,
